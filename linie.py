def check(b, t, w):
    ...
    if w[0][2]:
        if t[0][0] == t[0][1] == t[0][2] == t[0][3] == t[0][4]:
            ...
            w[0][1] = False
            w[0][0] = False
			respin_board[0][0],respin_board[0][1],respin_board[0][2],respin_board[0][3],respin_board[0][4] = False,False,False,False,False
    if w[0][1]:
    ...
    if w[0][5]:
        if t[1][0] == t[1][1] == t[1][2] == t[1][3] == t[1][4]:
            ...
            w[0][4] = False
            w[0][3] = False
			respin_board[1][0],respin_board[1][1],respin_board[1][2],respin_board[1][3],respin_board[1][4] = False,False,False,False,False
    if w[0][4]:
    ...
    if w[0][8]:
        if t[2][0] == t[2][1] == t[2][2] == t[2][3] == t[2][4]:
            ...
            w[0][7] = False
            w[0][6] = False
			respin_board[2][0],respin_board[2][1],respin_board[2][2],respin_board[2][3],respin_board[2][4] = False,False,False,False,False
    if w[0][7]:
    ...
    if w[1][2]:
        if t[0][0] == t[1][1] == t[2][2] == t[1][3] == t[0][4]:
            ...
            w[1][1] = False
            w[1][0] = False
			respin_board[0][0],respin_board[1][1],respin_board[2][2],respin_board[1][3],respin_board[0][4] = False,False,False,False,False
    if w[1][1]:
    ...
    if w[1][5]:
        if t[2][0] == t[1][1] == t[0][2] == t[1][3] == t[2][4]:
            ...
            w[1][4] = False
            w[1][3] = False
			respin_board[2][0],respin_board[1][1],respin_board[0][2],respin_board[1][3],respin_board[2][4] = False,False,False,False,False
    if w[1][4]:
    ...
    if w[1][8]:
        if t[1][0] == t[0][1] == t[0][2] == t[0][3] == t[1][4]:
            ...
            w[1][7] = False
            w[1][6] = False
			respin_board[1][0],respin_board[0][1],respin_board[0][2],respin_board[0][3],respin_board[1][4] = False,False,False,False,False
    if w[1][7]:
    ...
    if w[2][2]:
        if t[1][0] == t[2][1] == t[2][2] == t[2][3] == t[1][4]:
            ...
            w[2][1] = False
            w[2][0] = False
			respin_board[1][0],respin_board[2][1],respin_board[2][2],respin_board[2][3],respin_board[1][4] = False,False,False,False,False
    if w[2][1]:
    ...
    if w[2][5]:
        if t[0][0] == t[1][1] == t[1][2] == t[1][3] == t[0][4]:
            ...
            w[2][4] = False
            w[2][3] = False
			respin_board[0][0],respin_board[1][1],respin_board[1][2],respin_board[1][3],respin_board[0][4] = False,False,False,False,False
    if w[2][4]:
    ...
    if w[2][8]:
        if t[2][0] == t[1][1] == t[1][2] == t[1][3] == t[2][4]:
            ...
            w[2][7] = False
            w[2][6] = False
			respin_board[2][0],respin_board[1][1],respin_board[1][2],respin_board[1][3],respin_board[2][4] = False,False,False,False,False
    if w[2][7]:
